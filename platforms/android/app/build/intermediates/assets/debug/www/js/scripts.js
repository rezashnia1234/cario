    ...
    $.get("https://www.cario.ir/app/getServices.php", function (data, status) {
        ...
        jQuery.each(json, function (index, val) {
            ...
            for (var i = 0; i < val.length; i++) {
                ...
                serviceResponse += '<div class="relative fullWidthRel productBox waves-effect waves-yellow myCustomBoxShadow floatRigh serviceitem" id="' + service.id + '" data-price="' + service.price + '" data-rel="' + service.nothing + '" data-toggle="off">';
                ...
                serviceResponse += '<div class="fullWidthRel relative productDesc white-text"> ' + service.description + ' </div>';
                serviceResponse += '</div>';
                serviceResponse += '</div> ';
                serviceResponse += '</div>';
